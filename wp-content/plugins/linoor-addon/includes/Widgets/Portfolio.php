...
class Portfolio extends \Elementor\Widget_Base
{
    ...
    {
        return 'linoor-portfolio';
    }

    public function get_title()
    {
        return __('Portfolio', 'linoor-addon');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            'show_filter',
            [
                'label' => __('Enable Filter', 'linoor-addon'),
        ...
        $this->add_control(
            'category_count',
            [
                'label' => __('Number Of Category', 'linoor-addon'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['count'],
                'range' => [
                    'count' => [
                            ...
                            <?php if ('yes' === $settings['show_filter'] && !empty($portfolio_category) && !is_wp_error($portfolio_category)) : ?>
                                ...
                                <div class="filters clearfix">
                                    <ul class="filter-tabs filter-btns clearfix ml-0 list-unstyled">
                                        <li class="active filter" data-role="button" data-filter="all"><?php esc_html_e('All', 'linoor-addon'); ?><sup>[<?php echo esc_html($settings['post_count']['size']); ?>]</sup></li>
                                    ...
                                    <div class="project-carousel owl-theme owl-carousel">
                                        ...
                                        <?php while ($portfolio_layout_two_query->have_posts()) : ?>
                                            ...
                                            <div class="gallery-item">
                                                <div class="inner-box">
                                                    <figure class="image"><?php the_post_thumbnail('linoor_470X426'); ?></figure>
                                                    <a href="<?php echo esc_url(get_the_post_thumbnail_url(get_the_iD(), 'full')); ?>" class="lightbox-image overlay-box" data-fancybox="gallery"></a>
                                                    <div class="cap-box">
                                                        <div class="cap-inner">
                    ...
                    <div class="portfolio-masonary__filter-wrapper mixitup-gallery">
                        <?php if ('yes' === $settings['show_filter'] && !empty($portfolio_category) && !is_wp_error($portfolio_category)) : ?>
                            <ul class="ml-0 post-filter filter-btns clearfix filters has-dynamic-filter-counter">
                                <li class="active filter" data-role="button" data-filter=".filter-item"><?php esc_html_e('All', 'linoor-addon'); ?></li>
                                <?php foreach ($portfolio_category as $category) : ?>
                        ...
                        <a href="<?php echo esc_url(get_post_type_archive_link('portfolio')); ?>" class="portfolio-masonary__more"><?php echo esc_html__('View All', 'linoor-addon'); ?></a>
                        ...
                        <?php while ($post_query->have_posts()) : ?>
                            ...
                            <div class="col-lg-6 filter-item masonary-item <?php
                                ...
                                <div class="portfolio-masonary__box">
                                    <?php the_post_thumbnail('linoor_570X0'); ?>
                                    <div class="portfolio-masonary__box-content">
                                        <p><?php echo esc_html($category[0]->name); ?></p>
                                        <h4><a href="<?php the_permalink(); ?>"><?php echo wp_kses(get_the_title(), 'linoor_allowed_tags'); ?></a></h4>
                        ...
                        <?php while ($portfolio_horizontal_query->have_posts()) : ?>
                            ...
                            <div class="item">
                                <div class="portfolio-horizontal__card">
                                    <a href="<?php echo esc_url(get_the_post_thumbnail_url(get_the_iD(), 'full')); ?>" class="lightbox-image"><?php the_post_thumbnail('linoor_380X0'); ?></a>
                                    ...
                                    <h3 class="portfolio-horizontal__card__title">
                                        <a href="<?php the_permalink(); ?>"><?php echo wp_kses(get_the_title(), 'linoor_allowed_tags'); ?></a>
