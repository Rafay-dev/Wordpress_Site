...
class FooterCopyrightTwo extends \Elementor\Widget_Base
{
    ...
    {
        return __('Footer CopyRight Two', 'linoor-addon');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            'shape_image',
            [
                'label' => __('Shape Image', 'linoor-addon'),
        ...
        <div class="footer-bottom footer-bottom--two">
            ...
            <div class="auto-container">
                <div class="inner">
                    ...
                    <div class="copyright"><?php echo wp_kses($settings['text'], 'linoor_allowed_tags'); ?></div>
                </div>
            </div>
        </div>
<?php
