...
class Solutions extends \Elementor\Widget_Base
{
    ...
    {
        return 'linoor-solutions';
    }

    public function get_title()
    {
        return __('Solutions', 'linoor-addon');
    }
    ...
    protected function _register_controls()
    {
        $this->start_controls_section(
            'main_content',
            [
                'label' => __('Block Content', 'linoor-addon'),
        ...
        $this->start_controls_section(
            'list_section',
            [
                'label' => __('Check Lists', 'linoor-addon'),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
                                ...
                                <div class="tabs-content">
                                    ...
                                    <?php foreach ($settings['tabs'] as $tab_two) : ?>
                                        ...
                                        <div class="tab <?php echo esc_attr(('yes' == $get_content_status) ? 'active-tab' : ''); ?>" id="agency-tab-<?php echo esc_attr($tab_content_count); ?>">
                                            <div class="content">
                                                <div class="text"><?php echo wp_kses($tab_two['text'], 'linoor_allowed_tags'); ?></div>
                                            </div>
                                        </div>
