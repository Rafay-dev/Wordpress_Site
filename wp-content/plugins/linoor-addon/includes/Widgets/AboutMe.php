...
class AboutMe extends \Elementor\Widget_Base
{
    ...
    {
        return 'linoor-aboutme';
    }

    public function get_title()
    {
        return __('About Me', 'linoor-addon');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            'personal_image',
            [
                'label' => __('Add Thumbnail Image', 'linoor-addon'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __('Jhone Doe', 'linoor-addon'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'qoute_text',
            [
                'label' => __('Personal Qoute', 'linoor-addon'),
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => __('Some special text', 'linoor-addon'),
            ]
        );
        ...
        $this->add_control(
            'summery_list',
            [
                'label' => __('Summery List', 'linoor-addon'),
                'type' => \Elementor\Controls_Manager::REPEATER,
        ...
        $this->add_control(
            'certificate_images',
            [
                'label' => __('Certificate Image List', 'linoor-addon'),
                'type' => \Elementor\Controls_Manager::REPEATER,
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="about-me-one__content">
                            <div class="sec-title">
                                <h2><?php echo wp_kses($settings['name'], 'linoor_allowed_tags'); ?></h2>
                            </div>
                            ...
                            <?php foreach ($settings['summery_list'] as $summery) : ?>
                                <p class="about-me-one__text"><?php echo wp_kses($summery['text'], 'linoor_allowed_tags'); ?></p>

                            <?php endforeach; ?>

                            <p class="about-me-one__qoute"><?php echo wp_kses($settings['qoute_text'], 'linoor_allowed_tags'); ?></p>
                            <!-- /.about-me-one__qoute -->
