...
class Pricing
{
    ...
    public function register()
    {
        $slug = $this->slug;
        $labels = array(
            'name'                  => esc_html_x('Pricings', 'Post Type General Name', 'linoor-addon'),
            'singular_name'         => esc_html_x('Pricing', 'Post Type Singular Name', 'linoor-addon'),
