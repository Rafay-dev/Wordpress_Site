<?php
function linoor_demo_import()
{
    return array(
        array(
            'import_file_name'             => 'linoor Demo Import',
            'categories'                   => array('linoor'),
            ...
            'import_notice'                => __('Please keep patients while importing sample data.', 'linoor'),
            'preview_url'                  => 'http://www.your_domain.com/my-demo-1',
        ),
    );
}
add_filter('pt-ocdi/import_files', 'linoor_demo_import');
